...
import typing
__all__ = ['B1HandAction', 'B1HandIndex', 'B1HandType', 'B1JointCnt', 'B1JointIndex', 'B1LocoApiId', 'B1LocoClient', 'B1LowCmdPublisher', 'B1LowHandDataScriber', 'B1LowHandTouchDataScriber', 'B1LowStateSubscriber', 'B1OdometerStateSubscriber', 'ChannelFactory', 'DexterousFingerParameter', 'Frame', 'GetModeResponse', 'GripperControlMode', 'GripperMotionParameter', 'HandReplyData', 'HandReplyParam', 'HandTouchData', 'HandTouchParam', 'ImuState', 'LowCmd', 'LowCmdType', 'LowState', 'MotorCmd', 'MotorState', 'Odometer', 'Orientation', 'PARALLEL', 'Position', 'Posture', 'Quaternion', 'RobotMode', 'SERIAL', 'Transform', 'kBody', 'kChangeMode', 'kCrankDownLeft', 'kCrankDownRight', 'kCrankUpLeft', 'kCrankUpRight', 'kCustom', 'kDamping', 'kForce', 'kHandClose', 'kHandOpen', 'kHead', 'kHeadPitch', 'kHeadYaw', 'kInspireHand', 'kInspireTouchHand', 'kLeftElbowPitch', 'kLeftElbowYaw', 'kLeftFoot', 'kLeftHand', 'kLeftHipPitch', 'kLeftHipRoll', 'kLeftHipYaw', 'kLeftKneePitch', 'kLeftShoulderPitch', 'kLeftShoulderRoll', 'kMove', 'kPosition', 'kPrepare', 'kRevoHand', 'kRightElbowPitch', 'kRightElbowYaw', 'kRightFoot', 'kRightHand', 'kRightHipPitch', 'kRightHipRoll', 'kRightHipYaw', 'kRightKneePitch', 'kRightShoulderPitch', 'kRightShoulderRoll', 'kRotateHead', 'kUnknown', 'kWaist', 'kWalking']
class B1HandAction:
    """
    Members:
...
class B1HandType:
    ...
    Members:
      ...
      kUnknown
    """
    __members__: typing.ClassVar[dict[str, B1HandType]]  # value = {'kInspireHand': <B1HandType.kInspireHand: 0>, 'kInspireTouchHand': <B1HandType.kInspireTouchHand: 2>, 'kRevoHand': <B1HandType.kRevoHand: 3>, 'kUnknown': <B1HandType.kUnknown: -1>}
    kInspireHand: typing.ClassVar[B1HandType]  # value = <B1HandType.kInspireHand: 0>
    kInspireTouchHand: typing.ClassVar[B1HandType]  # value = <B1HandType.kInspireTouchHand: 2>
    kRevoHand: typing.ClassVar[B1HandType]  # value = <B1HandType.kRevoHand: 3>
    kUnknown: typing.ClassVar[B1HandType]  # value = <B1HandType.kUnknown: -1>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class B1LocoClient:
    ...
    def ChangeMode(self, mode: RobotMode) -> int:
        """
                         ...
                         */
        """
    def ControlDexterousHand(self, finger_params: list[DexterousFingerParameter], hand_index: B1HandIndex, hand_type: B1HandType) -> int:
        """
                        /**
...
class B1LowHandDataScriber:
    ...
    def __init__(self, handler: typing.Callable) -> None:
        """
                         ...
                         */
        """
class B1LowHandTouchDataScriber:
    def CloseChannel(self) -> None:
        """
        Close low state subscription channel
        """
...
class HandTouchData:
    __hash__: typing.ClassVar[None] = None
    touch_data: HandTouchParam
    def __eq__(self, arg0: HandTouchData) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: HandTouchData) -> None:
        ...
    def __ne__(self, arg0: HandTouchData) -> bool:
        ...
    @property
    def hand_index(self) -> int:
        ...
    ...
    def hand_type(self) -> int:
        ...
class HandTouchParam:
    __hash__: typing.ClassVar[None] = None
    finger_five: list[int]
    finger_four: list[int]
    finger_one: list[int]
    finger_palm: list[int]
    finger_three: list[int]
    finger_two: list[int]
    def __eq__(self, arg0: HandTouchParam) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: HandTouchParam) -> None:
        ...
    def __ne__(self, arg0: HandTouchParam) -> bool:
        ...
class ImuState:
    __hash__: typing.ClassVar[None] = None
    acc: list[float[3]]
...
kInspireHand: B1HandType  # value = <B1HandType.kInspireHand: 0>
kInspireTouchHand: B1HandType  # value = <B1HandType.kInspireTouchHand: 2>
...
kRevoHand: B1HandType  # value = <B1HandType.kRevoHand: 3>
