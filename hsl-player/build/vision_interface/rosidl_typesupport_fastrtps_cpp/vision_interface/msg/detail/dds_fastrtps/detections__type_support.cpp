...
#include "vision_interface/msg/detail/detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_interface::msg::Detections & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interface::msg::Detections & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interface::msg::Detections;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_interface::msg::Detections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interface::msg::Detections *>(
    untyped_ros_message);
...
{
  return &vision_interface::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interface, msg, Detections)() {
  return &vision_interface::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
