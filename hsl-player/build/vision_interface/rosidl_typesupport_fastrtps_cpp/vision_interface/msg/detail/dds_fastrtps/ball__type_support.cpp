...
#include "vision_interface/msg/detail/ball__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_interface::msg::Ball & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interface::msg::Ball & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interface::msg::Ball;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_interface::msg::Ball *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interface::msg::Ball *>(
    untyped_ros_message);
...
get_message_type_support_handle<vision_interface::msg::Ball>()
{
  return &vision_interface::msg::typesupport_fastrtps_cpp::_Ball__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interface, msg, Ball)() {
  return &vision_interface::msg::typesupport_fastrtps_cpp::_Ball__handle;
}
