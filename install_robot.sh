...
echo ""
echo "Para monitorar o deploy em tempo real:"
echo "  tail -f ~/Workspace/hl_unification/hsl-player/deploy.log"
echo ""
echo "Para parar tudo (incluindo o deploy):"
echo "  cd hsl-player && ./scripts/stop.sh"
echo ""
echo "Se houver processos deploy.py acumulados de reinicializações anteriores:"
echo "  pkill -9 -f 'deploy.py'"
echo ""
echo "Documentação de troubleshooting do deploy RL:"
echo "  docs/rl_deploy_debug.md"
echo ""
